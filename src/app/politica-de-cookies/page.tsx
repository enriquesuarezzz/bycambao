...
export const metadata: Metadata = {
  title: 'byCambao | Politica de Cookies',
  description: 'byCambao cookies policy page',
}
          ...
          <table className="w-full min-w-[800px] border border-black text-left">
            <tbody>
              ...
              <tr className="border border-black">
                <td rowSpan={2} className="border border-black px-2 py-1">
                  <MontserratText
                    text={'SEGÚN EL PLAZO DE TIEMPO QUE PERMANEZCAN ACTIVADAS'}
                    fontSize="16px"
                    className="pb-4 text-center"
                  />
                </td>
