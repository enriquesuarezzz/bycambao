...
export const metadata: Metadata = {
  title: 'byCambao | Aviso Legal',
  description: 'byCambao legal advice page',
}
  ...
  const data = [
    {
      ...
      content:
        'En cumplimiento del Reglamento General de Protección de Datos (UE) 2016/679 del Parlamento Europeo y del Consejo de 27 de abril de 2016 y la Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos Personales y garantía de los derechos digitales, se reflejan los siguientes datos: La empresa titular del presente dominio web <u> www.bycambao.com</u>',
    },
    {
      title: '2. Usuarios',
      content:
    ...
    },
    {
      ...
      content:
        'byCambao podrá modificar en cualquier momento las condiciones aquí determinadas, siendo debidamente publicadas como aquí aparecen. La vigencia de dichas condiciones dependerá de su exposición y estarán vigentes hasta que sean modificadas por otras debidamente publicadas.',
    },
    {
      title: '12. LEGISLACIÓN APLICABLE Y JURISDICCIÓN',
      content:
        'La relación entre byCambao y el usuario se regirá por la normativa española vigente y cualquier controversia se someterá a la autoridad pertinente.',
    },
  ]
  return (
    <main>
      ...
      <div className="mx-auto max-w-[1000px] items-center justify-center px-4 pt-10">
        {/* title */}
        <MontserratText
          text={'Aviso Legal'}
          tag="h1"
          fontSize="42px"
          style="semibold"
          className="pb-4 text-center text-orange"
        />
        {/* map of data, title + content */}
        {data.map(({ title, content }) => (
          <div key={title}>
            <MontserratText text={title} fontSize="20px" className="pb-8" />
            <MontserratText text={content} fontSize="16px" className="pb-8" />
          </div>
        ))}
      </div>
    </main>
